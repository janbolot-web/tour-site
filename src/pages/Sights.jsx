    ...
    return (
        ...
        >
            ...
            <div style={{ position: 'relative', height: isMobile ? '200px' : '300px', overflow: 'hidden' }}>
                ...
                {/* Tags */}
                <div style={{ position: 'absolute', top: '0.9rem', left: '0.9rem', display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
                    <span style={{
                        background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)',
                        border: '1px solid rgba(255,255,255,0.3)', borderRadius: '999px',
                        padding: isMobile ? '0.2rem 0.65rem' : '0.3rem 0.85rem',
                ...
                <div style={{ position: 'absolute', bottom: '1rem', left: '1rem', right: '1rem', color: '#fff' }}>
                    <h2 style={{
                        ...
                        fontWeight: 900, letterSpacing: '-0.03em', marginBottom: '0.2rem',
                    }}>
                        {sight.name}
                    </h2>
                    <p style={{ fontSize: isMobile ? '0.78rem' : '0.875rem', opacity: 0.82 }}>{sight.tagline}</p>
                </div>
            </div>
            ...
            <div style={{ padding: isMobile ? '1.1rem' : '1.75rem' }}>
                ...
                <div style={{ marginBottom: '1rem' }}>
                    <span style={{
                        ...
                        fontSize: '0.75rem', fontWeight: 600, color: 'hsl(var(--accent))',
                ...
                <div style={{
                    ...
                    >
                        ...
                        <ChevronDown size={15} style={{ transform: isExpanded ? 'rotate(180deg)' : 'none', transition: 'transform 0.3s' }} />
                    </button>
                    <a
                        href="/tours"
                        style={{
                            ...
                            padding: isMobile ? '0.5rem 0.95rem' : '0.6rem 1.25rem',
                            borderRadius: '0.6rem',
        ...
        <div style={{ paddingTop: '80px' }}>
            ...
            <section style={{
                ...
                <div className="container" style={{
                    position: 'relative', zIndex: 3, color: '#fff',
                    ...
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <span style={{
                            ...
                            <MapPin size={11} /> {allSights.length} Popular Sights
                        </span>
                        <h1 style={{
                            fontSize: isMobile ? 'clamp(1.7rem, 8vw, 2.4rem)' : 'clamp(2.5rem, 6vw, 5.5rem)',
                ...
                <div className="container" style={{
                    ...
                    >
                        <span style={{
                            ...
                            textTransform: 'uppercase', color: 'hsl(var(--secondary))',
                            display: 'block', marginBottom: '0.75rem',
                        }}>
                            Let Us Help
                        </span>
                        <h2 style={{
                            fontSize: isMobile ? 'clamp(1.75rem, 7vw, 2.5rem)' : 'clamp(2rem, 4vw, 3.5rem)',
                        ...
                        <p style={{
                            ...
                            opacity: 0.7, maxWidth: '36rem', margin: '0 auto',
                        ...
                        <div style={{
                            ...
                            <a
                                ...
                                style={{
                                    ...
                                    padding: isMobile ? '0.875rem 1.75rem' : '1rem 2.25rem',
